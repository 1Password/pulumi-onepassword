...
// Note 1: The `version` string below is comprised of a commit datetime+hash, the latest of which can be found on the `upstream-v2.40.0` branch.
// https://github.com/pulumi/terraform-plugin-sdk/commits/upstream-v2.40.0/
//
// Note 2: The `version` string below should match the `replace ...` line from the `go.mod` file in the `pulumi/pulumi-terraform-bridge` repo.
// https://github.com/pulumi/pulumi-terraform-bridge/blob/v3.132.0/go.mod
